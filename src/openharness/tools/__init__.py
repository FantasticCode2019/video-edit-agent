...
from openharness.tools.capcut_add_audios_tool import CapcutAddAudiosTool
from openharness.tools.capcut_add_captions_tool import CapcutAddCaptionsTool
from openharness.tools.capcut_add_effects_tool import CapcutAddEffectsTool
from openharness.tools.capcut_add_images_tool import CapcutAddImagesTool
from openharness.tools.capcut_add_keyframes_tool import CapcutAddKeyframesTool
from openharness.tools.capcut_add_masks_tool import CapcutAddMasksTool
from openharness.tools.capcut_add_sticker_tool import CapcutAddStickerTool
from openharness.tools.capcut_add_text_style_tool import CapcutAddTextStyleTool
from openharness.tools.capcut_add_videos_tool import CapcutAddVideosTool
from openharness.tools.capcut_create_draft_tool import CapcutCreateDraftTool
from openharness.tools.capcut_save_draft_tool import CapcutSaveDraftTool
from openharness.tools.video_edit_tool import VideoEditTool
from openharness.tools.video_probe_tool import VideoProbeTool
...
def create_default_tool_registry(mcp_manager=None) -> ToolRegistry:
    ...
    for tool in (
        ...
        TaskUpdateTool(),
        AgentTool(),
        CapcutCreateDraftTool(),
        CapcutSaveDraftTool(),
        CapcutAddVideosTool(),
        CapcutAddImagesTool(),
        CapcutAddAudiosTool(),
        CapcutAddStickerTool(),
        CapcutAddCaptionsTool(),
        CapcutAddTextStyleTool(),
        CapcutAddEffectsTool(),
        CapcutAddKeyframesTool(),
        CapcutAddMasksTool(),
        VideoProbeTool(),
        VideoEditTool(),
        SendMessageTool(),
